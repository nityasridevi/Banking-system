...
session_start();
$server="localhost";
$username="id19122209_root";
$password="8rbg0cH?jmqj7=>P";
$con=mysqli_connect($server,$username,$password,"id19122209_bank");
if(!$con){
...
<div class="row">
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                ...
                $username="id19122209_root";
                $password="8rbg0cH?jmqj7=>P";
                $db=mysqli_connect($server,$username,$password,"id19122209_bank");
